 ...
 * WebSocket example version 2022-06-18
 */
...
console.log("WebSocket remote API tool version 2022-06-18, Copyright (C) 2012-2022 Amarisoft");
...
for (var i = 2; i < process.argv.length; i++) {
    ...
    case '-t':
        ...
        break;
    case '--loop':
        loopCount = Math.max(1, process.argv[++i] >>> 0);
        break;
    case '-h':
    case '--help':
        Help();
...
ws.on('text', function (msg) {
    ...
    if (msg0) {
        ...
        case 'authenticate':
            if (msg0.ready) {
                console.log(getHeader(), '### Authenticated');
                Start();
                return;
            }
            ...
            console.log(getHeader(), '### Authentication required: name=' + msg0.name + ', type=' + msg0.type + ', version=' + msg0.version);
